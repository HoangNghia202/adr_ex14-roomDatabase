package com.example.ex14_roomdatabase;
...
//Adding a new course to sqlite data and pass all ourvalues to it.
        res.insert(course);
//After adding the data we are displaying a toastmessage
